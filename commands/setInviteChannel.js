...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      if (
        !interaction.channel.permissionsFor(botMember).has(Permissions.Flags.SEND_MESSAGES) ||
        !interaction.channel.permissionsFor(botMember).has(Permissions.Flags.EMBED_LINKS)
      ) {

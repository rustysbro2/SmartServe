...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      if (!interaction.member.permissions.has(GatewayIntentBits.FLAGS.MANAGE_GUILD)) {
      ...
      if (
        !interaction.channel.permissionsFor(botMember).has(GatewayIntentBits.FLAGS.SEND_MESSAGES) ||
        !interaction.channel.permissionsFor(botMember).has(GatewayIntentBits.FLAGS.EMBED_LINKS)
      ) {

...
module.exports = {
  ...
  async execute (interaction) {
    ...
    if (
      ...
      // Replace with the desired bot permissions
      await interaction.reply(
        "I need the 'ViewChannel' and 'SendMessage' permissions in a text channel to use this command."
      )
      return
    }
    ...
    try {
      ...
      interaction.editReply(
        `Pong! Bot latency: ${latency}ms, API latency: ${Math.round(
